<template>
    <div class="screen-controls" :style="{ top: isFullscreen ? '2rem' : '7rem' }">
        <v-btn :icon="isFullscreen ? 'mdi-fullscreen-exit' : 'mdi-fullscreen'" color="#ffb300" class="control-btn"
            density="comfortable" variant="elevated" @click="toggleFullscreen"></v-btn>
        <v-btn v-if="isMobileOrTablet" icon="mdi-screen-rotation" color="#ffb300" class="control-btn ml-2"
            density="comfortable" variant="elevated" @click="requestRotation"></v-btn>
    </div>
</template>
