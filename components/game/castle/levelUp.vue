...
<template>
    <v-overlay v-model="isModalShow" class="level-up-overlay" scrim="grey-darken-3" persistent>
        <v-sheet color="#ffb300" class="level-up-card d-flex flex-column justify-center align-center text-center"
            elevation="12" rounded>
            <v-icon size="80" color="white" class="bounce-icon mb-4">mdi-star</v-icon>

            <!-- Level Up Title -->
            <h1 class="text-h3 font-weight-bold white--text level-up-title mb-2">
                Level Up!
            </h1>
            ...
            <v-btn color="white" class="text-grey-darken-3 font-weight-bold" variant="flat" size="large"
                @click="closeLevelUp">
                Continue
            </v-btn>
        </v-sheet>
