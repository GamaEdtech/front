            ...
            <v-col cols="6">
              <div class="stats-section-stats__card darken-card">
                <div class="d-flex justify-space-between">
                  ...
                  <div class="stats-section-stats__card--percent">
                    +5.2%
                  </div>
                </div>
...
.stats-section-stats__card--icon {
  width: 24px;
  height: 20px;
  background: #07132f;
  display: flex;
...
.stats-section-stats__card--percent {
  background: #061530;
  width: 41px;
  height: 19px;
  border-radius: 20px;
...
.stats-section-stats__card--title {
  color: #0e1037;
  font-weight: 800;
  margin-top: 7px;
  font-size: 9px;
